...
impl ChainHash {
    ...
    pub const TESTNET: Self = Self::TESTNET3;
    ...
    pub const TESTNET4: Self = Self::TESTNET3;
    ...
    /// for specification.
    #[deprecated(since = "0.32.4", note = "Use using_genesis_block_const instead")]
    pub const fn using_genesis_block(network: Network) -> Self {
        Self::using_genesis_block_const(network)
    }
...
mod test {
    ...
    fn bitcoin_genesis_full_block() {
        let gen = genesis_block(&crate::consensus::params::MAINNET);
    ...
    fn testnet_genesis_full_block() {
        let gen = genesis_block(&crate::consensus::params::TESTNET3);
        assert_eq!(gen.header.version, block::Version::ONE);
        assert_eq!(gen.header.prev_blockhash, Hash::all_zeros());
        // Blackcoin ToDo!
        // assert_eq!(
    ...
    fn signet_genesis_full_block() {
        let gen = genesis_block(&crate::consensus::params::SIGNET);
        assert_eq!(gen.header.version, block::Version::ONE);
        assert_eq!(gen.header.prev_blockhash, Hash::all_zeros());
        // Blackcoin ToDo!
        // assert_eq!(
